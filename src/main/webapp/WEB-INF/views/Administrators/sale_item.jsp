  ...
  <head>
	...
	$(document).ready(function () { 
	        $('#SaleItemtable').bootstrapTable({
	            url: '${APP_PATH }/saleItem/searchByPage',         //请求后台的URL（*）
	            method: 'get',                      //请求方式（*）
	...
	//查询事件 
	function Search(){
		$('#SaleItemtable').bootstrapTable('refresh',{pageNumber:1});
    } 
        ...
        <div class="span9">
		  <div class="row-fluid">
			<div class="page-header">
				<h1>Sale_item <small>销售详情</small></h1>
				<div class="input-group">
				<input type="text" class="form-control"  id="saleItemId" placeholder="请输入检索关键字" />
